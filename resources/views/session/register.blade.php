      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="mb-2 mt-5">Buat Akun!</h1>
            <p class="text-lead">Masukkan Data Diri.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <p class="text-sm mt-3 mb-0">Sudah Punya Akun? <a href="login" class="text-dark font-weight-bolder">Sign in</a></p>
              </form>
            </div>
          </div>
        </div>

                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 14px;">{{ $pononadas->idNonadaPO}}</td>
                                    <td style="font-size: 14px;">{{ $pononadas->idNonadaPR}}</td>
                                    <td style="font-size: 14px;">{{ $pononadas->judulPekerjaan }}</td>
                                    <td style="font-size: 14px;">
                                        <a href="#" class="btn btn-sm btn-outline-warning editButton" data-bs-toggle="modal" data-bs-target=".modalEdit" data-id="{{ $pononadas->idNonadaPO }}">Edit</a>
                                        <form action="{{ route('pononada.destroy', $pononadas->idNonadaPO ) }}" method="POST" class="d-inline deleteForm" data-id="{{ $pononadas->idNonadaPO }}">
                                            @csrf
                                            @method('DELETE')
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body " style="max-height: 450px; overflow-y: auto;">
                                                ...
                                                <form action="{{ route('pononada.edit', $pononadas->idNonadaPO ) }}" method="POST" id="editForm">
                                                    @csrf
                                                    @method('PUT')
                                                    <!-- Isi form sesuai kebutuhan -->
                                                    <div class="mb-3">
                                                        <label for="noPek" class="form-label">Nomor Pekerja</label>
                                                        <input type="number" class="form-control" id="noPek" name="noPek" value="{{ $pononadas->noPek }}">
                                                    </div>

        ...
        <div class="row">
            <div class="card mb-3">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    <div class="d-flex">
                        <a href="{{ route('poreimburst.download-excel', ['search' => request()->input('search'), 'tahun' => request()->input('tahun'),'bulan' => request()->input('bulan')]) }}" class="btn btn-success btn-2x me-2">
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Tambah PO Reimburst</h5>
                                    ...
                                    <div class="modal-body" style="max-height: 450px; overflow-y: auto;">
                                        ...
                                        <form action="{{ route('poreimburst.store') }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="idReimburstPO" name="idReimburstPO">
                                            </div>
                                            <div class="mb-3">
                                                <label for="pr_reimburst_id" class="form-label">Pilih PR Reimburst</label>
                        ...
                        <!-- Reload data terbaru-->
                        <a href="{{ route('poreimburst') }}" class="btn btn-light btn-2x me-2">
            ...
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    <h6>Data Purchase Order Reimburst</h6>
                </div>
                ...
                <div class="card-body px-3 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @php $index = ($poreimbursts->currentPage() - 1) * $poreimbursts->perPage() + 1 @endphp
                                @foreach ($poreimbursts as $poreimburst)
                                <tr>
                                    <td style="font-size: 14px;">{{ $index }}</td>
                                    <td style="font-size: 14px;">{{ $poreimburst->idReimburstPO }}</td>
                                ...
                                <div class="modal fade" id="modalEdit{{ $poreimburst->idReimburstPO }}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('poreimburst.edit', $poreimburst->idReimburstPO) }}" method="POST" id="editForm" class="editForm">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="mb-3">
                                                        <label for="idReimburstPO" class="form-label">Nomor PO Reimburst</label>

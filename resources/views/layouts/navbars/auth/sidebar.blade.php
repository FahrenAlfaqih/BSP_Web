<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
      ...
      <span class="ms-3 font-weight-bold">Bumi Siak Pusako</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('sertifikasi') ? 'active' : '') }}" href="{{ url('sertifikasi') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Sertifikasi Training</span>
        </a>
      </li>
      <!-- Magang -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('magang') ? 'active' : '') }}" href="{{ url('magang') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>document</title>
              <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <!-- SPD -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('spd') ? 'active' : '') }}" href="{{ url('spd') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">SPD</span>
        </a>
      </li>
      <!-- DPD -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('dpd') ? 'active' : '') }}" href="{{ url('dpd') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">DPD</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('ses') ? 'active' : '') }}" href="{{ url('ses') }}">
          ...
          <span class="nav-link-text ms-1">Service Entry Sheet</span>
        </a>
      </li>
    </ul>
  </div>

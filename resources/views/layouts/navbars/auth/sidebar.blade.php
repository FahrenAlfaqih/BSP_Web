<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <!-- User Admin HCM -->
      @if(auth()->user()->email == 'adminhrm@mail.com')
      ...
      <!-- User Admin FINEC ICT -->
      @elseif(auth()->user()->email == 'adminfinec@mail.com')
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Kelola Pengajuan SPD </h6>
      </li>
      <!-- SPD -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('spd') ? 'active' : '') }}" href="{{ url('spd') }}">
